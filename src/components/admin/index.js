...
export function AdminPanel(){
    ...
    const orders = [
        ...
        {orderNo: 'KFM3', noOfTrays: 5, amount: '30,000', date: '9-06-2021', contact: '0770256256', location: 'Mengo', status: 'completed'},
        {orderNo: 'KFM4', noOfTrays: 6, amount: '35,000', date: '10-06-2021', contact: '0770258986', location: 'Najjera', status: 'failed'},
        ...
        {orderNo: 'KFM8', noOfTrays: 6, amount: '35,000', date: '13-06-2021', contact: '0770256256', location: 'Najjera', status: 'failed'},
        ...
        {orderNo: 'KFM14', noOfTrays: 6, amount: '35,000', date: '10-06-2021', contact: '0770258986', location: 'Najjera', status: 'failed'},
        ...
        {orderNo: 'KFM18', noOfTrays: 6, amount: '35,000', date: '13-06-2021', contact: '0770256256', location: 'Najjera', status: 'failed'},
    ]

    const filters = ['Date Added', 'Location', 'Status']
        ...
        <MainWrapper>
            ...
            <RightWrapper>
                <TopBar>
                    ...
                    <div>
                        <span>Filter by: </span>
                        <DropDown options={filters} width='200px' height='35px' mr='30px' />
                    </div>
                </TopBar>
